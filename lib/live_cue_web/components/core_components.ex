defmodule LiveCueWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiveCueWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiveCueWeb.Gettext, "errors", msg, opts)
    end
  end
